        ...
        function m.Drag(u, v, A)
            ...
            local function update(J)
                ...
                m.Tween(
                    ...
                    0.02,
                    {
                        Position = UDim2.new(G.X.Scale, G.X.Offset + L.X, G.Y.Scale, G.Y.Offset + L.Y)
                    }
                ):Play()
            end
...
function a.d()
        ...
        function g.New(h)
            ...
            if i.Icon then
                ...
                -- Apply Custom Icon Color if present
                if i.IconColor and j:FindFirstChild("ImageLabel") then
                    j.ImageLabel.ImageColor3 = i.IconColor
                    -- We manually set a property on the wrapper to trick theme updater or ensure precedence
                    if j.ImageLabel:FindFirstChild("ThemeTag") then j.ImageLabel.ThemeTag:Destroy() end
                end
            end
    ...
    function a.e()
        ...
        local function Z(g)
            ...
            return w(
                y(h[1], 4) ..
                    y(h[2], 4) .. y(h[3], 4) .. y(h[4], 4) .. y(h[5], 4) .. y(h[6], 4) .. y(h[7], 4) .. y(h[8], 4)
            )
        end
        local g
        local h = {["\\"] = "\\", ['"'] = '"', ["\b"] = "b", ["\f"] = "f", ["\n"] = "n", ["\r"] = "r", ["\t"] = "t"}
        ...
        function ab.New(ac)
            ...
            function ValidateKey(ag)
                local ah =
                    ...
                    tostring(ag) .. "&service=" .. tostring(ac) .. "&hwid=" .. tostring(ad())
                    ...
                    if aj.Success then
                        ...
                        warn(
                            "[Pelinda Ov2.5] HTTP request was not successful. Code: " ..
                                tostring(aj.StatusCode) .. " Message: " .. aj.StatusMessage
                        )
        ...
        return [[
{
            ...
            local az =
                ...
                function()
                    ...
                    if not ag.KeySystem.API then
                        local aB =
                            type(ag.KeySystem.Key) == "table" and table.find(ag.KeySystem.Key, az) or
                            ag.KeySystem.Key == az
    ...
    function a.o()
        ...
        return function(af)
            ...
            aa.AddSignal(
                aj:GetPropertyChangedSignal "AbsolutePosition",
                function()
                    ah(aj)
                end
            )
            ...
            aa.AddSignal(
                aj:GetPropertyChangedSignal "AbsoluteSize",
                function()
                    ah(aj)
                end
            )
            ...
            ag.AddParent = function(ak)
                aa.AddSignal(
                    ak:GetPropertyChangedSignal "Visible",
                    function()
        ...
        ac = {
            ...
            Parser = {
                ...
                ToggleKeybind = {
                    ...
                    Load = function(ad, ae)
                        if ad and ad.Set then
                            ad.Set(nil, ae.value, true)
                        end
                        if ad and ad.SetKey and ae.key then
                            ad.SetKey(nil, ae.key)
                        end
                    end
                },
                Slider = {
    ...
    function a.x()
        ...
        function aa.New(ae)
            ...
            ab.AddSignal(
                al:GetPropertyChangedSignal "AbsoluteSize",
                function()
    ...
    function a.z()
        ...
        return function(ae)
            ...
            local function CreateText(am, an)
                local ao =
                    typeof(af.Color) == "string" and GetTextColorForHSB(Color3.fromHex(aa.Colors[af.Color])) or
                    typeof(af.Color) == "Color3" and GetTextColorForHSB(af.Color)
                        ...
                        },
                        {
                            ab(
                                "UIListLayout",
                                {
                                    Padding = UDim.new(0, af.UIPadding),
                                    FillDirection = "Horizontal",
                                    VerticalAlignment = ae.Window.NewElements and
                                        (af.Justify == "Between" and "Top" or "Center") or
                                        "Center",
            ...
            local aB, aC =
                ...
                "Squircle",
                {
                    ...
                    ImageColor3 = af.Color and
                        (typeof(af.Color) == "string" and Color3.fromHex(aa.Colors[af.Color]) or
                            typeof(af.Color) == "Color3" and af.Color) or
                        nil
                },
                {
                    af.UIElements.Container,
            ...
            function af.Colorize(aD, aE, b)
                if af.Color then
                    aE[b] =
                        typeof(af.Color) == "string" and GetTextColorForHSB(Color3.fromHex(aa.Colors[af.Color])) or
                        typeof(af.Color) == "Color3" and GetTextColorForHSB(af.Color) or
                        nil
                end
            end
            ...
            if ae.ElementTable then
                aa.AddSignal(
                    am:GetPropertyChangedSignal "Text",
                    function()
    ...
    function a.A()
        ...
        function ac.New(ae, af)
            ...
            local textAlignment = alignMap[af.Align] or Enum.TextXAlignment.Left
            ...
            local mainContainer = ah.UIElements.Container
            if mainContainer then
                local titleFrameOuter = mainContainer:FindFirstChild("TitleFrame")
                if titleFrameOuter then
                    local innerTitleFrame = titleFrameOuter:FindFirstChild("TitleFrame")

                    if innerTitleFrame then
                        if innerTitleFrame:FindFirstChild("Title") then
                            innerTitleFrame.Title.TextXAlignment = textAlignment
                            innerTitleFrame.Title.RichText = true
                        end
                        if innerTitleFrame:FindFirstChild("Desc") then
                            innerTitleFrame.Desc.TextXAlignment = textAlignment
                            innerTitleFrame.Desc.TextTransparency = 0.15
                            innerTitleFrame.Desc.RichText = true
                        end
                        if textAlignment == Enum.TextXAlignment.Center then
                            local layout = innerTitleFrame:FindFirstChildOfClass("UIListLayout")
                            if layout then
                    ...
                    local iconObj = titleFrameOuter:FindFirstChild("ImageLabel")
                    if iconObj then
                        aa.AddThemeObject(iconObj, {ImageColor3 = "Accent"})
                    end
                end
            end
            ...
            if af.Buttons and #af.Buttons > 0 then
                ...
                local btnCount = #af.Buttons
                local widthScale = (btnCount % 2 == 0 or btnCount > 2) and 0.48 or 1
                ...
                for aj, ak in next, af.Buttons do
                    local btn =
                        ...
                        nil,
                        nil,
                        af.Window.NewElements and 12 or 10
                    )
                    btn.Size = UDim2.new(widthScale, -4, 0, 32)
                end
            end
    ...
    function a.F()
        ...
        function ae.New(ag, ah)
            ...
            local ar =
                ai.SliderFrame.Parent:IsA "ScrollingFrame" and ai.SliderFrame.Parent or
                ai.SliderFrame.Parent.Parent.Parent

            function ai.Set(as, at, au)
                if ap then
                    if
                        not ai.IsFocusing and not af and
                            (not au or
                                (au.UserInputType == Enum.UserInputType.MouseButton1 or
                                    au.UserInputType == Enum.UserInputType.Touch))
                     then
                        ...
                        if au then
                            ...
                            ak =
                                ...
                                function()
                                    local aw =
                                        aj and au.Position.X or game:GetService "UserInputService":GetMouseLocation().X
                                    local ax =
                                        math.clamp(
                            ...
                            al =
                                ...
                                function(aw)
                                    if
                                        (aw.UserInputType == Enum.UserInputType.MouseButton1 or
                                            aw.UserInputType == Enum.UserInputType.Touch) and
                                            au == aw
                                     then
                                        ak:Disconnect()
                                        al:Disconnect()
                                        ...
                                        ad(
                                            ...
                                            .2,
                                            {
                                                Size = UDim2.new(
                                                    0,
                                                    ah.Window.NewElements and (ai.ThumbSize * 1.75) or
                                                        (ai.ThumbSize + 2),
                                                    0,
                                                    ai.ThumbSize + 2
                                                )
            ...
            aa.AddSignal(
                ai.UIElements.SliderContainer.TextBox.FocusLost,
                function(as)
                    if as then
            ...
            aa.AddSignal(
                ai.UIElements.SliderContainer.InputBegan,
                function(as)
                    ai:Set(am, as)

                    if
                        as.UserInputType == Enum.UserInputType.MouseButton1 or
                            as.UserInputType == Enum.UserInputType.Touch
                     then
                        ad(
                            ai.UIElements.SliderIcon.Frame.Thumb,
                            .24,
    ...
    function a.G()
        ...
        function af.New(ah, ai)
            ...
            ac.AddSignal(
                aj.KeybindFrame.UIElements.Main.MouseButton1Click,
                function()
                    if ak then
                            ...
                            al =
                                ...
                                function(am)
                                    ...
                                    ao =
                                        ...
                                        function(ap)
                                            if
                                                ap.KeyCode.Name == an or
                                                    an == "MouseLeft" and
                                                        ap.UserInputType == Enum.UserInputType.MouseButton1 or
                                                    an == "MouseRight" and
    ...
    function a.I()
        ...
        function ac.New(ad, ae)
            local text = (type(ad) == "table" and ad.Text) or (type(ad) == "string" and ad) or nil

            local containerHeight = text and 24 or 14
            ...
            local container =
                ...
                {
                    Parent = ae.Parent,
                    Size = UDim2.new(1, -14, 0, containerHeight),
                    BackgroundTransparency = 1,
                    Name = "Divider"
                }
            )
            ...
            return "Divider", {__type = "Divider", ElementFrame = container}
        end
    ...
    function a.J()
        ...
        function aa.New(al, am, an, ao, ap)
            ...
            function aq.Refresh(as, at)
                ...
                for aw, ax in next, at do
                    if (ax.Type ~= "Divider") then
                        ...
                        if ap == "Dropdown" then
                            ai.AddSignal(
                                ay.UIElements.TabItem.MouseButton1Click,
                                function()
                                    if ay.Locked then
                                        return
                                    end
                        ...
                        elseif ap == "Menu" then
                            if not ay.Locked then
                                ai.AddSignal(
                                    ay.UIElements.TabItem.MouseEnter,
                                    function()
                                        ak(ay.UIElements.TabItem, 0.08, {ImageTransparency = .95}):Play()
                                    end
                                )
                                ai.AddSignal(
                                    ay.UIElements.TabItem.InputEnded,
                                    function()
            ...
            ai.AddSignal(
                (am.UIElements.Dropdown and am.UIElements.Dropdown.MouseButton1Click or
                    am.DropdownFrame.UIElements.Main.MouseButton1Click),
                function()
                    aq:Open()
                end
            )
    ...
    function a.O()
        ...
        function aq.Colorpicker(ar, as, at, au)
            ...
            ac.AddSignal(
                i.Frame.Frame.TextBox.FocusLost,
                function(G)
                    if G then
        ...
        function aq.New(ar, as)
            ...
            ac.AddSignal(
                at.UIElements.Colorpicker.MouseButton1Click,
                function()
                    if au then
                        aq:Colorpicker(
                            at,
    ...
    function a.P()
        ...
        function ai.New(aj, ak)
            local al = {
                ...
                Subtitle = ak.Subtitle or ak.Desc or nil,
                Icon = ak.Icon,
                TextXAlignment = ak.TextXAlignment or "Left",
                TextSize = ak.TextSize or 17,
                Box = ak.Box or true,
                FontWeight = ak.FontWeight or Enum.FontWeight.Medium,
                TextTransparency = ak.TextTransparency or 0.2,
                Opened = ak.Opened or false,
                UIElements = {},
                HeaderSize = (ak.Subtitle or ak.Desc) and 50 or 42,
                IconSize = 18,
                Padding = 12,
                Elements = {},
                Expandable = false
            ...
            function al.SetIcon(an, ao)
                ...
                if ao then
                    ...
                    am.ImageLabel.ImageTransparency = 0.3
                    am.LayoutOrder = 0
                end
            end
                ...
                },
                {
                    ae(
                        "UIListLayout",
                        {
                            ...
                            VerticalAlignment = "Center",
                            HorizontalAlignment = al.TextXAlignment == Enum.TextXAlignment.Center and "Center" or "Left"
                        }
                    )
                }
            )
            ...
            local function UpdateTitleSize()
                local widthReduct = 0
                if am then
                    widthReduct = widthReduct + (al.IconSize + 10)
                end
                if an.Visible then
                    widthReduct = widthReduct + (al.IconSize + 10)
                end
                textWrapper.Size = UDim2.new(1, -widthReduct, 0, 0)
            end
            ...
            local sectionDivider =
                ...
                "Frame",
                {
                    ...
                    Position = UDim2.new(0, 12, 0, al.HeaderSize - 1),
                    BackgroundTransparency = 1,
                    ThemeTag = {
                        BackgroundColor3 = "Outline"
                    }
            ...
            local ap =
                ...
                "Squircle",
                {
                    ...
                    ClipsDescendants = true,
                    AutomaticSize = "Y",
                    ImageTransparency = al.Box and 0.96 or 1,
                    ThemeTag = {
                        ImageColor3 = "Text"
                    }
                },
                {
                    ...
                    ae(
                        "TextButton",
                        {
                            Size = UDim2.new(1, 0, 0, al.Expandable and 0 or al.HeaderSize),
                            BackgroundTransparency = 1,
                            AutomaticSize = al.Expandable and nil or "Y",
                            Text = "",
                            Name = "Top"
                        },
                        {
            ...
            ac.AddSignal(
                ...
                function()
                    if al.Expandable then
                        ag(ap, 0.15, {ImageTransparency = 0.94}):Play()
                    end
                end
            )
            ...
            ac.AddSignal(
                ...
                function()
                    if al.Expandable then
                        ag(ap, 0.15, {ImageTransparency = al.Box and 0.96 or 1}):Play()
                    end
                end
            )
            ...
            aq.Load(
                ...
                function()
                    if not al.Expandable then
                        al.Expandable = true
                        an.Visible = true
                        ap.AutomaticSize = Enum.AutomaticSize.None
            ...
            function al.SetSubtitle(ar, as)
                al.Subtitle = as
                subtitleLabel.Text = as or ""
                subtitleLabel.Visible = (as ~= nil and as ~= "")
                if not al.Expandable and (as ~= nil and as ~= "") then
                    al.HeaderSize = 50
                    ap.Top.Size = UDim2.new(1, 0, 0, 50)
                end
            end
            ...
            function al.Open(ar)
                if al.Expandable then
                    ...
                    local targetSize = UDim2.new(1, 0, 0, al.HeaderSize + (ap.Content.AbsoluteSize.Y / ak.UIScale))
                    ...
                    ag(an.ImageLabel, 0.25, {Rotation = 180}, Enum.EasingStyle.Back, Enum.EasingDirection.Out):Play()

                    ag(sectionDivider, 0.2, {BackgroundTransparency = 0.85}):Play()
                end
            end
            ...
            function al.Close(ar)
                if al.Expandable then
                    ...
                    ag(an.ImageLabel, 0.3, {Rotation = 0}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()

                    ag(sectionDivider, 0.15, {BackgroundTransparency = 1}):Play()
                end
            end
            ...
            local function checkAutomaticSize()
                if al.Opened and al.Expandable then
                    local contentSize = ap.Content.UIListLayout.AbsoluteContentSize.Y
                    local paddingY = ap.Content.UIPadding.PaddingTop.Offset + ap.Content.UIPadding.PaddingBottom.Offset

                    ap.Size = UDim2.new(1, 0, 0, al.HeaderSize + (contentSize + paddingY) / ak.UIScale)
                end
            end
            ...
            task.spawn(
                function()
                    ...
                    if al.Expandable then
                        ap.AutomaticSize = Enum.AutomaticSize.None
                        ap.Top.AutomaticSize = Enum.AutomaticSize.None
                        ap.Top.Size = UDim2.new(1, 0, 0, al.HeaderSize)
                        ap.Content.Visible = true

                        ap.Content.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
                            checkAutomaticSize
                        )
                    end
                    if al.Opened then
...
function a.MS()
        ...
        function ae.New(af, ag)
            local sectionData = {
                ...
                TextSize = ag.TextSize or 17,
                Box = (ag.Box == nil and true) or ag.Box,
                FontWeight = ag.FontWeight or Enum.FontWeight.Medium,
                TextTransparency = ag.TextTransparency or 0.2,
                HeaderSize = (ag.Subtitle or ag.Desc) and 50 or 42,
                IconSize = 18,
                Pages = {},
                SectionButtons = {},
                CurrentSection = nil,
            ...
            function sectionData.SetIcon(s, icon)
                ...
                if icon then
                    ...
                    iconImg.ImageLabel.ImageTransparency = 0.3
                ...
                },
                {
                    ab(
                        "UIListLayout",
                        {
                            ...
                            Padding = UDim.new(0, 2),
                            VerticalAlignment = "Center",
                            HorizontalAlignment = sectionData.TextXAlignment == Enum.TextXAlignment.Center and "Center" or
                                "Left"
                        }
                    )
                }
            ...
            local subLbl =
                ...
                "TextLabel",
                {
                    ...
                    Text = sectionData.Subtitle or "",
                    Size = UDim2.new(1, 0, 0, 0),
                    TextWrapped = true,
                    LayoutOrder = 2,
                    Visible = (sectionData.Subtitle ~= nil),
                    Parent = textWrapper
                }
            )
            ...
            local divider =
                ...
                "Frame",
                {
                    Name = "Divider",
                    Size = UDim2.new(1, -24, 0, 1),
                    Position = UDim2.new(0, 12, 0, sectionData.HeaderSize - 1),
                    BackgroundTransparency = 1,
                    ThemeTag = {BackgroundColor3 = "Outline"}
                }
            )
            ...
            local mainFrame =
                ...
                "Squircle",
                {
                    ...
                    ClipsDescendants = true,
                    AutomaticSize = "Y",
                    ImageTransparency = sectionData.Box and 0.96 or 1,
                    ThemeTag = {ImageColor3 = "Text"}
                },
                {
                    ad(
                    ...
                    ab(
                        ...
                        {
                            ab("UIPadding", {PaddingLeft = UDim.new(0, 14), PaddingRight = UDim.new(0, 14)}),
                            iconImg,
                            textWrapper,
                            ab(
                                "UIListLayout",
            ...
            aa.AddSignal(
                ...
                function()
                    if navList.UIListLayout.AbsoluteContentSize.X > (navList.AbsoluteSize.X - 24) then
            ...
            local function Resize()
                ...
                local headH = sectionData.HeaderSize
                
                local contentListSize = contentHolder.UIListLayout.AbsoluteContentSize.Y
                local paddingTop = contentHolder.UIPadding.PaddingTop.Offset
                local paddingBottom = contentHolder.UIPadding.PaddingBottom.Offset
                
                local contentH = (contentListSize + paddingTop + paddingBottom) / ag.UIScale

                ac(
                    mainFrame,
                    0.35,
                    {Size = UDim2.new(1, 0, 0, headH + contentH)},
                    Enum.EasingStyle.Quint,
                    Enum.EasingDirection.Out
                ):Play()
            end
            ...
            for i, sInfo in ipairs(parsed) do
                ...
                local pFrame =
                    ...
                    },
                    {
                        ...
                        ab("UIPadding", {PaddingTop = UDim.new(0, 4), PaddingBottom = UDim.new(0, 4)})
                    }
                )
                ...
                local pill =
                    ...
                    "Squircle",
                    {
                        ...
                        ImageTransparency = (i == 1 and 0.15 or 1),
                        ZIndex = 1
                    }
                )
                ...
                if sInfo.Icon then
                    ...
                    if i == 1 then
                        aa.AddThemeObject(icon.ImageLabel, {ImageColor3 = "WindowBackground"})
                    else
                        aa.AddThemeObject(icon.ImageLabel, {ImageColor3 = "Text"})
                        icon.ImageLabel.ImageTransparency = 0.4
                    end
                ...
                local lbl =
                    ...
                    "TextLabel",
                    {
                        ...
                        TextSize = 14,
                        AutomaticSize = "XY",
                        ThemeTag = {TextColor3 = (i == 1 and "WindowBackground" or "Text")},
                ...
                local btnContainer =
                    ...
                    },
                    {
                        ...
                        ab(
                            "Frame",
                            {BackgroundTransparency = 1, AutomaticSize = "XY", Size = UDim2.new(0, 0, 1, 0), ZIndex = 2},
                            {
                                ab(
                                    "UIListLayout",
                                    {
                ...
                local function updateVisuals(isActive, isHover)
                    local targetTrans = isActive and 0.15 or (isHover and 0.9 or 1)
                    ac(pill, 0.2, {ImageTransparency = targetTrans}):Play()

                    local fg = isActive and "WindowBackground" or "Text"
                    local fgTrans = (isActive or isHover) and 0 or 0.4
                    local fontW = isActive and Enum.FontWeight.Bold or Enum.FontWeight.Medium

                    lbl.FontFace = Font.new(aa.Font, fontW)
                    aa.UpdateTheme(lbl)
                    aa.AddThemeObject(lbl, {TextColor3 = fg})
                    ac(lbl, 0.2, {TextTransparency = fgTrans}):Play()

                    if sInfo.Icon then
                        local icon = btnContainer:FindFirstChild("BtnIcon", true)
                        if icon then
                            aa.AddThemeObject(icon.ImageLabel, {ImageColor3 = fg})
                            ac(icon.ImageLabel, 0.2, {ImageTransparency = fgTrans}):Play()
                        end
                    end
                end
                ...
                aa.AddSignal(
                    ...
                    function()
                        ...
                        local btnX =
                            btnContainer.AbsolutePosition.X - navList.AbsolutePosition.X + navList.CanvasPosition.X
                        ac(
                            navList,
                            0.3,
                            {
                                CanvasPosition = Vector2.new(
                                    btnX - navList.AbsoluteSize.X / 2 + btnContainer.AbsoluteSize.X / 2,
                                    0
                                )
                            }
                        ):Play()
            ...
            function sectionData.Open()
                ...
                ac(chevron.Arrow, 0.25, {Rotation = 180}, Enum.EasingStyle.Back, Enum.EasingDirection.Out):Play()
                ac(divider, 0.2, {BackgroundTransparency = 0.85}):Play()
            end
            ...
            function sectionData.Close()
                ...
                ac(chevron.Arrow, 0.3, {Rotation = 0}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                ac(divider, 0.15, {BackgroundTransparency = 1}):Play()
            end

            function sectionData.SetTitle(s, t)
                sectionData.Title = t
                titleLbl.Text = t
            end
            function sectionData.SetSubtitle(s, st)
                sectionData.Subtitle = st
                subLbl.Text = st or ""
                subLbl.Visible = (st ~= nil and st ~= "")
                if st and st ~= "" and sectionData.HeaderSize ~= 50 then
                    sectionData.HeaderSize = 50
                    mainFrame.Top.Size = UDim2.new(1, 0, 0, 50)
                    contentHolder.Position = UDim2.new(0, 0, 0, 50)
                    divider.Position = UDim2.new(0, 12, 0, 49)
            ...
            aa.AddSignal(
                ...
                function()
                    ac(mainFrame, 0.15, {ImageTransparency = 0.94}):Play()
                end
            )
            aa.AddSignal(
    ...
    function a.LabelImpl()
        ...
        function ad.New(ae, af)
            local ag = {
                __type = "Label",
                Title = af.Title or "Label",
                Desc = af.Desc or nil,
                Value = af.Value or "",
                Color = af.Color,
                Icon = af.Icon,
                IconThemed = af.IconThemed or false,
                Callback = af.Callback or nil,
                UIElements = {},
                Locked = false
            }

            local isInteractive = (ag.Callback ~= nil)
            local isHovering = false

            local initialColor = Color3.fromRGB(200, 200, 200)
            if ag.Color and typeof(ag.Color) == "Color3" then
                initialColor = ag.Color
            end
            ...
            local valHolder =
                ...
                "Frame",
                {
                    ...
                    Position = UDim2.new(1, 0, 0.5, 0),
                    BackgroundTransparency = 1,
                    Parent = ag.Frame.UIElements.Main
                }
            )
            ...
            if typeof(ag.Color) == "string" then
                aa.AddThemeObject(ag.UIElements.Value, {TextColor3 = ag.Color})
            elseif not ag.Color then
                aa.AddThemeObject(ag.UIElements.Value, {TextColor3 = "Text"})
            end

            if ag.Icon then
                local valIcon = aa.Image(ag.Icon, "ValIcon", 0, af.Window.Folder, "Label", true, ag.IconThemed)
                valIcon.Parent = valHolder
                valIcon.Size = UDim2.new(0, 16, 0, 16)
                valIcon.LayoutOrder = 1
                valIcon.BackgroundTransparency = 1

                if not ag.IconThemed then
                    valIcon.ImageLabel.ImageColor3 = initialColor
                    if typeof(ag.Color) == "string" then
                        aa.AddThemeObject(valIcon.ImageLabel, {ImageColor3 = ag.Color})
                    elseif not ag.Color then
                        aa.AddThemeObject(valIcon.ImageLabel, {ImageColor3 = "Text"})
                    end
                    valIcon.ImageLabel.ImageTransparency = 0.4
                end

                ag.UIElements.Icon = valIcon.ImageLabel
            end

            if isInteractive then
                aa.AddSignal(
                    ag.Frame.UIElements.Main.MouseEnter,
                    function()
                        isHovering = true
                        if ag.Locked then
                            return
                        end
                        ac(ag.UIElements.Value, 0.2, {TextTransparency = 0.1}):Play()
                        if ag.UIElements.Icon then
                            ac(ag.UIElements.Icon, 0.2, {ImageTransparency = 0.1}):Play()
                        end
                    end
                )

                aa.AddSignal(
                    ag.Frame.UIElements.Main.MouseLeave,
                    function()
                        isHovering = false
                        if ag.Locked then
                            return
                        end
                        ac(ag.UIElements.Value, 0.2, {TextTransparency = 0.4}):Play()
                        if ag.UIElements.Icon then
                            ac(ag.UIElements.Icon, 0.2, {ImageTransparency = 0.4}):Play()
                        end
                    end
                )

                aa.AddSignal(
                    ag.Frame.UIElements.Main.MouseButton1Click,
                    function()
                        if ag.Locked then
                            return
                        end
                        ...
                        if ag.Callback then
                            task.spawn(
                                function()
                                    aa.SafeCallback(ag.Callback, ag.Value)
                                end
                            )
                        end
                    end
            ...
            function ag.Set(self, text)
                ag.Value = text
                ag.UIElements.Value.Text = tostring(text)
            end

            function ag.Get(self)
                return ag.Value
            end

            function ag.SetTitle(self, text)
                if ag.Frame.SetTitle then
                    ag.Frame:SetTitle(text)
                end
                ag.Title = text
            end

            function ag.SetDesc(self, text)
                if ag.Frame.SetDesc then
                    ag.Frame:SetDesc(text)
                end
                ag.Desc = text
            end

            function ag.SetColor(self, color)
                ag.Color = color
                if typeof(color) == "Color3" then
                    ag.UIElements.Value.TextColor3 = color
                    if ag.UIElements.Icon then
                        ag.UIElements.Icon.ImageColor3 = color
                    end
                elseif typeof(color) == "string" then
                    aa.AddThemeObject(ag.UIElements.Value, {TextColor3 = color})
                    if ag.UIElements.Icon then
                        aa.AddThemeObject(ag.UIElements.Icon, {ImageColor3 = color})
                    end
                end
            end

            function ag.Lock(self)
                ag.Locked = true
                if ag.Frame.Lock then
                    ag.Frame:Lock()
                end
                ac(ag.UIElements.Value, 0.2, {TextTransparency = 0.7}):Play()
            end

            function ag.Unlock(self)
                ag.Locked = false
                if ag.Frame.Unlock then
                    ag.Frame:Unlock()
                end
                ac(ag.UIElements.Value, 0.2, {TextTransparency = 0.4}):Play()
            end
        ...
        function al.New(am, an)
            ...
            local TabGlow =
                ...
                "ImageLabel",
                {
                    Name = "TabGlow",
                    BackgroundTransparency = 1,
                    Image = "rbxassetid://92390900241936",
                    ImageTransparency = 1,
                    Size = UDim2.new(1, 0, 1, 0),
                    ThemeTag = {ImageColor3 = "Accent"},
                    ScaleType = "Slice",
                        ...
                        },
                        {
                            ...
                            ag(
                                "TextLabel",
                                {
                                    ...
                                    TextTransparency = not ao.Locked and 0.5 or .8,
                                    TextSize = 15,
                                    Size = UDim2.new(1, 0, 0, 0),
                                    FontFace = Font.new(ae.Font, Enum.FontWeight.Medium),
                                    TextWrapped = true,
            ...
            if ao.Icon then
                ...
                ar.Size = UDim2.new(0, 18, 0, 18)
                ar.Parent = ao.UIElements.Main.Frame
                ar.ImageLabel.ImageTransparency = not ao.Locked and 0.5 or .8
                ar.LayoutOrder = 1

                ao.UIElements.Main.Frame.Title.Size = UDim2.new(1, -38, 0, 0)
                aq = -38

                ao.UIElements.Icon = ar

                as = ae.Image(ao.Icon, ao.Icon .. ":" .. ao.Title, 0, Window.Folder, ao.__type, true, ao.IconThemed)
                as.Size = UDim2.new(0, 24, 0, 24)
            ...
            ao.UIElements.ContainerFrameCanvas =
                ag(
                "Frame",
                {
                    Size = UDim2.new(1, 0, 1, 0),
            ...
            ae.AddSignal(
                ao.UIElements.Main.MouseButton1Click,
                function()
                            ...
                            function()
                                ...
                                if aw and not at then
                                    ...
                                    local function updatePosition()
                                        if at then
                                            at.Container.Position = UDim2.new(0, ac.X, 0, ac.Y - 24)
                                        end
                                    end
                                    updatePosition()
            ...
            ae.AddSignal(
                ao.UIElements.Main.MouseEnter,
                function()
                    if not ao.Locked and not ao.Selected then
                        ai(ao.UIElements.Main, 0.2, {ImageTransparency = 0.95}):Play()
                        ai(ao.UIElements.Main.Frame.ContentPadding, 0.2, {PaddingLeft = UDim.new(0, 16)}):Play()
                    end
                end
            )

            ae.AddSignal(
                ao.UIElements.Main.InputEnded,
                function()
                    if ao.Desc then
                        aw = false
                        if au then
                    ...
                    if not ao.Locked and not ao.Selected then
                        ai(ao.UIElements.Main, 0.2, {ImageTransparency = 1}):Play()
                        ai(ao.UIElements.Main.Frame.ContentPadding, 0.2, {PaddingLeft = UDim.new(0, 12)}):Play()
                    end
                end
            )
            ...
            function ao.LockAll(ax)
                for ay, az in next, Window.AllElements do
                    if az.Tab and az.Tab.Index == ao.Index and az.Lock then
                        az:Lock()
                    end
                end
            end
            function ao.UnlockAll(ax)
                for ay, az in next, Window.AllElements do
                    if az.Tab and az.Tab.Index == ao.Index and az.Unlock then
                        az:Unlock()
                    end
                end
            end
            function ao.GetLocked(ax)
                ...
                for az, aA in next, Window.AllElements do
                    if aA.Tab and aA.Tab.Index == ao.Index and aA.Locked == true then
                        table.insert(ay, aA)
                    end
                end
                return ay
            ...
            function ao.GetUnlocked(ax)
                local ay = {}
                for az, aA in next, Window.AllElements do
                    if aA.Tab and aA.Tab.Index == ao.Index and aA.Locked == false then
                        table.insert(ay, aA)
                    end
                end
                return ay
            ...
            task.spawn(
                function()
                    ...
                    ay =
                        ae.AddSignal(
                        ao.UIElements.ContainerFrame.ChildAdded,
                        function()
                            ax.Visible = false
                            ay:Disconnect()
                        end
            ...
            if not al.Tabs[an].Locked then
                ...
                for ao, ap in next, al.Tabs do
                    if not ap.Locked then
                        ai(ap.UIElements.Main, 0.2, {ImageTransparency = 1}):Play()
                        ai(ap.UIElements.Main.Outline, 0.2, {ImageTransparency = 0.92}):Play()

                        ai(ap.UIElements.Main.Frame.Title, 0.2, {TextTransparency = 0.5}):Play()
                        if ap.UIElements.Icon then
                            ai(ap.UIElements.Icon.ImageLabel, 0.2, {ImageTransparency = 0.5}):Play()
                        end

                        ai(ap.UIElements.TabGlow, 0.2, {ImageTransparency = 1}):Play()

                        ai(ap.UIElements.Main.Frame.ContentPadding, 0.2, {PaddingLeft = UDim.new(0, 12)}):Play()

                        ap.Selected = false
                    end
                end

                local targetTab = al.Tabs[an]

                ai(targetTab.UIElements.Main, 0.25, {ImageTransparency = 0.9}):Play()
                ai(targetTab.UIElements.Main.Outline, 0.25, {ImageTransparency = 0.7}):Play()

                ai(targetTab.UIElements.Main.Frame.Title, 0.25, {TextTransparency = 0}):Play()
                if targetTab.UIElements.Icon then
                    ai(targetTab.UIElements.Icon.ImageLabel, 0.25, {ImageTransparency = 0}):Play()
                end

                ai(targetTab.UIElements.TabGlow, 0.3, {ImageTransparency = 0.85}):Play()

                ai(targetTab.UIElements.Main.Frame.ContentPadding, 0.25, {PaddingLeft = UDim.new(0, 16)}):Play()
        ...
        function ac.new(aj, ak, al)
            ...
            local function CreateSearchTab(as, at, au, av, aw, ax)
                ...
                ay.Main.Size =
                    ...
                    0,
                    0,
                    ay.Main.Outline.Frame.Desc.Visible and
                        (((am.Padding - 2) * 2) + ay.Main.Outline.Frame.Title.TextBounds.Y + 6 +
                            ay.Main.Outline.Frame.Desc.TextBounds.Y) or
                        (((am.Padding - 2) * 2) + ay.Main.Outline.Frame.Title.TextBounds.Y)
                )
            ...
            ae.AddSignal(
                ap.UIListLayout:GetPropertyChangedSignal "AbsoluteContentSize",
                function()
                    ai(
                        ap,
                        .06,
            ...
            ae.AddSignal(
                ao.TextButton.MouseButton1Click,
                function()
                    am:Close()
                end
            )
    ...
    function a.X()
        ...
        return function(aq)
                                ...
                                aj(
                                    ...
                                    },
                                    {
                                        aj(
                                            "TextLabel",
                                            {
                                                Text = ar.User.Anonymous and "Anonymous" or
            ...
            local aE =
                typeof(ar.Background) == "string" and not aD and string.match(ar.Background, "^https?://.+") or nil
                ...
                if string.find(aD, "http") then
                    ...
                    if not isfile(b) then
                        local e, g =
                            ...
                            function()
                                local e =
                                    ai.Request {Url = aD, Method = "GET", Headers = {["User-Agent"] = "Roblox/Exploit"}}
                                writefile(b, e.Body)
                            end
                        )
                        if not e then
            ...
            ai.AddSignal(
                ar.UIElements.Main.Main.Topbar.Left:GetPropertyChangedSignal "AbsoluteSize",
                function()
                    local i = 0
                    local j =
                        ar.UIElements.Main.Main.Topbar.Right.UIListLayout.AbsoluteContentSize.X / aq.WindUI.UIScale
                    if h and e then
                    ...
                    if g then
                        i =
                            i + (ar.IconSize / aq.WindUI.UIScale) + (ar.UIPadding / aq.WindUI.UIScale) +
                            (4 / aq.WindUI.UIScale)
                    end
            ...
            if ar.OpenButtonMain and ar.OpenButtonMain.Button then
                ai.AddSignal(
                    ar.OpenButtonMain.Button.TextButton.MouseButton1Click,
                    function()
                        ar:Open()
                    end
                )
            ...
            function ar.SidebarParagraph(u, v)
                local CreateButton = am or a.load("j").New

                local A = {
                    Title = v.Title,
                    Content = v.Content or v.Desc or nil,
                    Thumbnail = v.Thumbnail,
                    ThumbnailSize = v.ThumbnailSize or 50,
                    Icon = v.Icon,
                    IconThemed = v.IconThemed,
                    Buttons = v.Buttons or {},
                    ProgressBar = v.ProgressBar or nil,
                    ProgressText = v.ProgressText or nil,
                    Clickable = v.Callback or nil,
                    Badge = v.Badge or nil,
                    Container = nil
                }

                local targetSize = v.Size or UDim2.new(1, 0, 0, 0)
                local targetAutoSize = v.AutomaticSize or Enum.AutomaticSize.Y

                local function getSize(val)
                    if typeof(val) == "UDim2" then
                        return val
                    end
                    local px = tonumber(val) or 50
                    return UDim2.new(0, px, 0, px)
                end

                local ThumbnailContainer = nil
                if A.Thumbnail then
                    local thumbWrapper =
                        aj(
                        "Frame",
                        {
                            Size = getSize(A.ThumbnailSize),
                            BackgroundTransparency = 1
                        }
                    )

                    local thumb = ai.Image(A.Thumbnail, "Thumbnail", 10, ar.Folder, "SidebarThumb", false)
                    thumb.Size = UDim2.new(1, 0, 1, 0)
                    thumb.BackgroundTransparency = 1
                    thumb.Name = "Image"
                    thumb.Parent = thumbWrapper

                    if thumb:FindFirstChild("ImageLabel") then
                        thumb.ImageLabel.ScaleType = Enum.ScaleType.Crop
                        local corner =
                            thumb.ImageLabel:FindFirstChild("UICorner") or Instance.new("UICorner", thumb.ImageLabel)
                        corner.CornerRadius = UDim.new(0, 10)

                        local stroke =
                            thumb.ImageLabel:FindFirstChild("UIStroke") or Instance.new("UIStroke", thumb.ImageLabel)
                        stroke.Transparency = 0.8
                        stroke.Thickness = 1
                        ai.AddThemeObject(stroke, {Color = "Text"})
                    end
                    ...
                    ThumbnailContainer =
                        ...
                        },
                        {
                            ...
                            thumbWrapper,
                            aj("UIPadding", {PaddingBottom = UDim.new(0, 12)})
                        }
                    )
                    A.ThumbnailObj = thumb.ImageLabel
                end
                ...
                if v.Icon then
                    local ico = ai.Image(v.Icon, "Icon", 0, ar.Folder, "SidebarIcon", v.IconThemed or false)
                    ico.Size = UDim2.new(0, 16, 0, 16)
                    ico.BackgroundTransparency = 1
                    ico.Parent = HeaderFrame

                    if ico:FindFirstChild("ImageLabel") then
                        ico.ImageLabel.ImageTransparency = 0
                        if not v.IconThemed then
                            ai.AddThemeObject(ico.ImageLabel, {ImageColor3 = "Text"})
                        end
                    end
                    A.IconObj = ico
                end
                ...
                if (A.Title or v.Icon) and A.Content then
                    aj("UIPadding", {Parent = ContentLbl, PaddingTop = UDim.new(0, 4)})
                end

                local ProgressContainer = nil
                local FillFrame = nil

                if A.ProgressBar then
                    local clampVal = math.clamp(A.ProgressBar or 0, 0, 1)
                    ...
                    FillFrame.Parent = ProgBg

                    local ProgLabel = nil
                    if A.ProgressText then
                        ProgLabel =
                            aj(
                            "TextLabel",
                            {
                    ...
                    ProgressContainer =
                        ...
                        {
                            aj("UIListLayout", {Padding = UDim.new(0, 6)}),
                            aj("UIPadding", {PaddingTop = UDim.new(0, 12)}),
                            ProgLabel,
                            ProgBg
                        }
                    )
                ...
                if A.Buttons and #A.Buttons > 0 then
                    ...
                    for idx, btnData in ipairs(A.Buttons) do
                        local btn =
                            CreateButton(
                            btnData.Title,
                            btnData.Icon,
                            btnData.Callback,
                            btnData.Variant or "Secondary",
                            ButtonContainer,
                            ar.Window
                        )
                        ...
                        if btn:FindFirstChild("Squircle") and btn.Squircle:FindFirstChild("Frame") then
                            local txt = btn.Squircle.Frame:FindFirstChild("TextLabel")
                            if txt then
                                txt.TextSize = 12
                            end
                        end
                ...
                local ParagraphCard =
                    ...
                    "Squircle",
                    {
                        AutomaticSize = targetAutoSize,
                        Size = targetSize,
                        ImageTransparency = 0.96,
                        ThemeTag = {ImageColor3 = "Text"},
                        Active = (A.Clickable ~= nil)
                    },
                    {
                        aj(
                            "UIGradient",
                ...
                if A.Clickable then
                    local outline = ParagraphCard:FindFirstChild("Outline")

                    ai.AddSignal(
                        ParagraphCard.MouseEnter,
                        function()
                            ai.Tween(ParagraphCard, 0.2, {ImageTransparency = 0.9}):Play()
                            ai.Tween(outline, 0.2, {ImageTransparency = 0.6}):Play()
                        end
                    )

                    ai.AddSignal(
                        ParagraphCard.MouseLeave,
                        function()
                            ai.Tween(ParagraphCard, 0.2, {ImageTransparency = 0.96}):Play()
                            ai.Tween(outline, 0.2, {ImageTransparency = 0.85}):Play()
                        end
                    )

                    ai.AddSignal(
                        ParagraphCard.InputBegan,
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseButton1 then
                                ai.Tween(ParagraphCard, 0.1, {ImageTransparency = 0.85}):Play()
                                task.delay(
                                    0.05,
                                    function()
                                        ai.SafeCallback(A.Clickable)
                                        ai.Tween(ParagraphCard, 0.2, {ImageTransparency = 0.9}):Play()
                                    end
                                )
                            end
                ...
                function A.SetTitle(self, str)
                    A.Title = str
                    TitleLbl.Text = str or ""
                    HeaderFrame.Visible = (str ~= nil and str ~= "") or (v.Icon ~= nil)
                end

                function A.SetContent(self, str)
                    A.Content = str
                    ContentLbl.Text = str or ""
                    ContentLbl.Visible = (str ~= nil and str ~= "")
                end

                function A.SetSize(self, newSize)
                    ParagraphCard.Size = newSize
                end

                function A.SetAutomaticSize(self, autoEnum)
                    ParagraphCard.AutomaticSize = autoEnum
                end

                function A.SetThumbnail(self, image, size)
                    if image then
                        A.Thumbnail = image
                        if A.ThumbnailObj then
                            A.ThumbnailObj.Image = image
                        end
                    end
                    if size and A.ThumbnailObj then
                        A.ThumbnailObj.Parent.Size = getSize(size)
                    end
                    if ThumbnailContainer and A.ThumbnailObj then
                        ThumbnailContainer.Visible = (A.ThumbnailObj.Image ~= nil and A.ThumbnailObj.Image ~= "")
                    end
                end

                function A.SetProgress(self, value, textOverride)
                    if not FillFrame then
                        return
                    end
                    local cl = math.clamp(value, 0, 1)
                    ai.Tween(
                        FillFrame,
                        0.6,
                        {Size = UDim2.new(cl, 0, 1, 0)},
                        Enum.EasingStyle.Quint,
                        Enum.EasingDirection.Out
                    ):Play()

                    if textOverride and ProgressContainer then
                        local lbl = ProgressContainer:FindFirstChild("TextLabel")
                        if lbl then
                            lbl.Text = textOverride
                        end
                    end
                end

                if not v.Thumbnail then
                    if ThumbnailContainer then
                        ThumbnailContainer.Visible = false
                    end
                end
                if (not A.Title or A.Title == "") and not v.Icon then
                    HeaderFrame.Visible = false
                end
                if not A.Content or A.Content == "" then
            ...
            b.Frame.MouseButton1Up:Connect(
                function()
                    local F = tick()
                    local G = ar.Position
...
local aq = game:GetService("CoreGui"):WaitForChild("RobloxGui")
    ...
    if at.KeySystem then
        ...
        if not at.KeySystem.API then
            if at.KeySystem.SaveKey and isfile(az) then
                ...
                local aB =
                    (type(at.KeySystem.Key) == "table") and table.find(at.KeySystem.Key, aA) or
                    tostring(at.KeySystem.Key) == tostring(aA)
