...
Text.Text = "What is Auto Execute? Auto Execute is a function that allows the script to run automatically when the player enters, leaves or is teleported to another place. If you want to activate this function, press the button below."
...
Button1.MouseButton1Click:Connect(function()
    queueTeleport("wait(4) loadstring(game:HttpGet('https://raw.githubusercontent.com/Lmy-x77/InfinityX/refs/heads/scripts/games/Hunty-Zombie/source.lua'))()")
