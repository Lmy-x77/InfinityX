...
Text.Size = UDim2.new(1, -30, 0, 110)
...
Text.Text = "<font size='14' color='#E0E0E0'>Your current executor does not support the required functions to properly run this script.</font>\n<font size='14' color='#FFD166'>Detected Executor: </font><font size='15' color='#00FFCC'><b>" .. executor .. "</b></font>\n<font size='13' color='#B0B0B0'>For the best experience, please switch to a fully compatible executor. Thank you for using InfinityX.</font>"
...
Button1.Text = "Copy discord link"
