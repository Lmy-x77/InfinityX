...
local TrainingAreas = loadstring(game:HttpGet("https://raw.githubusercontent.com/Lmy-x77/InfinityX/refs/heads/scripts/games/Anime-Fighinting-Simulator-Endless/modules/TrainingAreas.lua"))()
...
local Areas = TrainingAreas:WorldOne()
