...
function Areas:WorldOne()
	return {
		[1] = {
			...
			{ 1e20, math.huge, { nil, 2, 3858, 669, -1076 } },
		},
		[2] = {
			...
			{ 1e20, math.huge, { nil, 2, 1673, 2305, -78 } },
		},
		[3] = {
			...
			{ 1e20, math.huge, { nil, 2, 341, 237, 1867 } },
		},
		[5] = {
...
function Areas:WorldTwo()
	return {
		[1] = {
			{ 1e21, 1e23, { nil, 2, 747, 212, 3721 } },
			{ 1e23, 1e24, { nil, 2, 2108, 354, 2131 } },
			{ 1e24, 1e26, { nil, 2, 2656, 866, -964 } },
			{ 1e26, 1e27, { nil, 2, 208, 9, 653 } },
			{ 1e27, 1e29, { nil, 2, 203, -607, -933 } },
			{ 1e29, 1e30, { nil, 2, -2237, 433, -1132 } },
			{ 1e30, math.huge, { nil, 2, 1315, 215, 66 } },
		},
		[2] = {
			{ 1e21, 1e23, { nil, 2, -3804, 619, 1356 } },
			{ 1e23, 1e24, { nil, 2, -4479, 27, -1717 } },
			{ 1e24, 1e26, { nil, 2, -969, 10, -3446 } },
			{ 1e26, 1e27, { nil, 2, -720, 3, 1858 } },
			{ 1e27, 1e29, { nil, 2, -1893, 378, -2160 } },
			{ 1e29, 1e30, { nil, 2, -981, 167, -394 } },
			{ 1e30, math.huge, { nil, 2, 146, 3, -189 } },
		},
		[3] = {
			{ 1e21, 1e23, { nil, 2, -928, 550, 4226 } },
			{ 1e23, 1e24, { nil, 2, 1232, 167, -931 } },
			{ 1e24, 1e26, { nil, 2, -3413, 433, 1544 } },
			{ 1e26, 1e27, { nil, 2, 945, 3, 727 } },
			{ 1e27, 1e29, { nil, 2, 525, 21, -1535 } },
			{ 1e29, 1e30, { nil, 2, 910, 1433, -2514 } },
			{ 1e30, math.huge, { nil, 2, 1265, 208, -1511 } },
		}
	}
end
