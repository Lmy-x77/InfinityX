...
bg.BackgroundColor3 = Color3.fromRGB(25, 53, 33)
...
for i = 1, #word do
	...
	label.TextColor3 = Color3.fromRGB(50, 168, 82) -- cor base verde
	...
	gradient.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromRGB(85, 255, 150)),
...
subtitle.Text = "Beta Tester Version"
